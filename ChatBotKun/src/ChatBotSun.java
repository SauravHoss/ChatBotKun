...
public class ChatBotSun 
{
	 ...
	 */ 
		...
		public String getResponse(String statement)
		{
			...
			{
				response = "WHy you gotta be like this :(";
	                	emotion--;
			}
			
			else if (findKeyword(statement, "party") >= 0)
			{
				response = "Where do you usually go";
				emotion++;
			}

			// Response transforming I want to statement
			else if (findKeyword(statement, "I would love too", 0) >= 0)
			{
				response = transformIWantToStatement(statement);
			}
			else if (findKeyword(statement, "I would",0) >= 0)
			{
		...
		private String transformIWantToStatement(String statement)
		{
			...
			int psn = findKeyword (statement, "I would love to", 0);
